...
#endif
#if defined(EXT0_HEATER_PIN_X2) && EXT0_HEATER_PIN>-1
    SET_OUTPUT(EXT0_HEATER_PIN_X2);
...
#endif
#if defined(EXT1_HEATER_PIN_X2) && EXT1_HEATER_PIN_X2>-1 && NUM_EXTRUDER>1
    SET_OUTPUT(EXT1_HEATER_PIN_X2);
