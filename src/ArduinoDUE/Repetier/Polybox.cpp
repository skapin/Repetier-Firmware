...
void init_cn()
{
    ...
    SETUP_PIN( CONTACT_POINT_A, PIN_TYPE_INPUT);
    SETUP_PIN( CONTACT_POINT_B, PIN_TYPE_INPUT);
    SETUP_PIN( CONTACT_POINT_C, PIN_TYPE_INPUT);
}
...
void init_scanner()
{
    ...
    SETUP_PIN( TABLE0_DETECTED_PIN, PIN_TYPE_INPUT);
